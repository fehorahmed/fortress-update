...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('contractor.ledger') }}">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="supplier">
                                        ...
                                        @foreach($contractors as $contractor)
                                            <option value="{{ $contractor->id }}" {{ request()->get('contractor') == $contractor->id ? 'selected' : '' }}>{{ $contractor->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div id="prinarea">
                        <div class="row" id="heading_area" style="margin-bottom: 10px!important;display: none">
                            <div class="col-sm-12 text-center" style="font-size: 16px">
                                ...
                                <strong style="border: 2px solid #000;padding: 1px 10px;font-size: 19px;">Contractor Report</strong>
...
{{--                                        <th class="text-center">৳ {{number_format($orders->sum('total'))}}</th>--}}
                                        <th class="text-center">৳ {{number_format($orders->sum('amount'))}}</th>
