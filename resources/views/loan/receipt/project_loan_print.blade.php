                    ...
                    <div id="prinarea">
                        ...
                        <div class="row" id="heading_area" style="margin-bottom: 10px!important;display: none; position: relative">
                            <div class="col-sm-12 text-center" style="font-size: 16px">
                                ...
                                <strong style="border: 2px solid #000;padding: 1px 10px;font-size: 19px;">Tender Loan</strong>
                        ...
                        <div class="col-xs-12">
                            <table class="table table-bordered">
                                <tbody>
                                <tr>
                                    <td width="80%" style="border-bottom: 1px solid #fff !important;" colspan="7">Tender Name: &nbsp;&nbsp;<strong>{{ $loan->tender->name }}</strong><p style="border-bottom: 1px dotted #000;margin-left: 150px;"></p></td>
                                ...
                                <tr>
                                    <td width="80%" style="border-bottom: 1px solid #fff !important;" colspan="7">Address: <strong>{{ $loan->tender->address }}</strong><p style="border-bottom: 1px dotted #000;margin-left: 50px;"></p></td>
