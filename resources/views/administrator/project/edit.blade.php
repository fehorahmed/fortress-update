    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('project.edit', ['project' => $project->id]) }}">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('opening_balance') ? 'has-error' :'' }}">
                            <label class="col-sm-2 control-label">Opening Balance(Cash) *</label>

                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter Opening Balance"
                                       name="opening_balance" value="{{ empty(old('opening_balance',0)) ? ($errors->has('opening_balance',0) ? '' : $project->cash->opening_balance??'0') : old('opening_balance',0) }}">
