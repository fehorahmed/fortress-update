        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header with-border">
                    <h3 class="card-title">Contractor Payment Edit Information</h3>
                </div>

                <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('contractor_receipt.payment_edit',['payment' => $payment->id]) }}">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group row {{ $errors->has('name') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" readonly
                                       value="{{ old('name',$payment->contractor->name??'') }}">
                                @error('name')
                        ...
                        <div class="form-group row {{ $errors->has('contractor_due') ? 'has-error' :'' }}">
                            <label for="contractor_due" class="col-sm-2 control-label">Contractor Due *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="contractor_due" readonly
                                       value="{{ old('contractor_due', $payment->contractor->due) }}">
                                @error('contractor_due')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
