                                ...
                                <table id="table-payments" class="table table-bordered table-striped">
                                    ...
                                    @foreach($contractor->payments as $payment)
                                        <tr>
                                            ...
                                            <td>{{ $payment->note }}</td>
                                            <td>
                                                <a href="{{ route('contractor_receipt.payment_details', ['payment' => $payment->id]) }}" id="delete" class="btn btn-primary btn-sm">Details</a>
                                                <a href="{{ route('contractor_receipt.payment_edit', ['payment' => $payment->id]) }}" class="btn btn-warning btn-sm">Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
