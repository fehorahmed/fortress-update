            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="modal-form" enctype="multipart/form-data" name="modal-form">
                        ...
                        <div class="form-group">
                            <label>Segment</label>
                            <select class="form-control" id="modal-segment" name="segment" style="width: 100%">
                        ...
                        <div class="form-group">
                            <label>Date (The format must be followed <span class="text-danger">*</span>)</label>
                            <div class="input-group date">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </div>
                                <input type="text" class="form-control pull-right" name="date" placeholder="DD/MM/YY" autocomplete="off">
                            </div>
                            <!-- /.input group -->
                        </div>
                        <div class="form-group">
            ...
            $('#modal-btn-pay').click(function () {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        // Re-enable the button when the AJAX request is successful
                        $('#modal-btn-pay').prop('disabled', false);
                    ...
                    error: function (error) {
                        // Re-enable the button when there is an error in the AJAX request
                        $('#modal-btn-pay').prop('disabled', false);
                    }
                });
            });
