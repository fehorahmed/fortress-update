    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('segment.project.add') }}">
                    @csrf
...
{{--                        </div>--}}
                        ...
                        <div class="form-group row {{ $errors->has('segment_percentage') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter Percentage for Segment Project"
