                ...
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('transaction.add') }}">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('account_head_type') ? 'has-error' :'' }}">
                            <label class="col-sm-2 control-label">Account Head Name *</label>

                            <div class="col-sm-10">
                                <select class="form-control" name="account_head_type" id="account_head_type">
                                    <option value="">Select Account Head Name</option>
                                </select>
                        ...
                        <div class="form-group {{ $errors->has('account_head_sub_type') ? 'has-error' :'' }}">
                            <label class="col-sm-2 control-label">Account Head Sub Name *</label>

                            <div class="col-sm-10">
                                <select class="form-control" name="account_head_sub_type" id="account_head_sub_type">
                                    <option value="">Select Account Head Sub Name</option>
                                </select>
    ...
    <script>
        $(function () {
            ...
            $('#type').change(function () {
                ...
                $('#account_head_sub_type').html('<option value="">Select Account Head Sub Name</option>');
