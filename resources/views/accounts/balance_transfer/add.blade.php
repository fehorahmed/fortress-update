...
{{--                                    <option value="4" {{ old('type') == '4' ? 'selected' : '' }}>Cheque To Bank</option>--}}
{{--                                    <option value="5" {{ old('type') == '5' ? 'selected' : '' }}>Cheque To Cach</option>--}}
                                </select>
                        ...
                        <div id="source-bank-info">
                            <div class="form-group row {{ $errors->has('source_bank') ? 'has-error' :'' }}">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2" name="source_bank" id="source_bank">
                            ...
                            <div class="form-group row {{ $errors->has('source_branch') ? 'has-error' :'' }}">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2" name="source_branch" id="source_branch">
                        ...
                        <div id="target-bank-info">
                            <div class="form-group row {{ $errors->has('target_bank') ? 'has-error' :'' }}">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2" name="target_bank" id="target_bank">
                                        <option value="">Select Bank</option>
                            ...
                            <div class="form-group row {{ $errors->has('target_branch') ? 'has-error' :'' }}">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2" name="target_branch" id="target_branch">
                                        <option value="">Select Branch</option>
                                    </select>
                        ...
                        <div class="form-group row {{ $errors->has('date') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group ">
                                    ...
                                    <input type="text" class="form-control pull-right" name="date" value="{{ empty(old('date')) ? ($errors->has('date') ? '' : date('Y-m-d')) : old('date') }}" autocomplete="off">
                                </div>
                                <!-- /.input group -->
